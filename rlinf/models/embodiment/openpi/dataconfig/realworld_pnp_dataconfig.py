...
Paired with
:class:`~rlinf.models.embodiment.openpi.policies.realworld_pnp_policy.RealworldPnPInputs`
...
from rlinf.models.embodiment.openpi.policies import realworld_pnp_policy
...
class LeRobotRealworldPnPDataConfig(DataConfigFactory):
    ...
    def create(
        ...
        data_transforms = _transforms.Group(
            inputs=[
                realworld_pnp_policy.RealworldPnPInputs(
            ...
            outputs=[realworld_pnp_policy.RealworldPnPOutputs()],
        )
